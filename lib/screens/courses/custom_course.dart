...
class CustomCourse extends StatefulWidget {
  ...
  const CustomCourse({super.key, required this.courseName, required this.changeCourse});
...
class _CustomCourseState extends State<CustomCourse> {
    ...
    return [
      SliverGrid(
        ...
        delegate: SliverChildBuilderDelegate(
            ...
            return GridItem(index: index, unitList: hskList, updateUnits: update, courseName: widget.courseName, allowSkipUnits: allowSkipUnits,);
          },
  ...
  Widget build(BuildContext context) {
    return CourseView(unitList: unitNumList, update: update, courseName: widget.courseName, gridItems: gridItems, changeCourse: widget.changeCourse,);
  }
}
