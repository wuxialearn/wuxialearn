...
class _StatsHomeState extends State<StatsHome> {
  ...
  initState() {
    ...
    recentHskList =
        getStats(sortBy: "last_seen", orderBy: "DESC", deckSize: 10);
  ...
  Future<List<Map<String, dynamic>>> getStats(
    ...
    return await StatsSql.getStats(
        sortBy: sortBy, orderBy: orderBy, deckSize: deckSize, where: where);
  }
                      ...
                      FutureBuilder<List<Map<String, dynamic>>>(
                          ...
                          builder: (BuildContext context,
                            ...
                            if (snapshot.hasData) {
                              ...
                              return const _StatsChart(timeline: [
                                {
                          ...
                          builder: (BuildContext context,
                            ...
                            if (snapshot.hasData) {
                              ...
                              final String mostSeen =
                                  statsList[0]["most_seen"] ?? "";
                              final int mostSeenId =
                                  statsList[0]["most_seen_id"] ?? 0;
                              final int newWords = statsList[0]["new_words"];
                              final int reviewWords =
                                  statsList[0]["review_words"];
                              final int successRate =
                                  statsList[0]["percent_correct"] ?? 0;
                              return _QuickStats(
...
class TotalStats extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final String currHsk = globalStats["current_hsk"] == "2"
        ? "1-2"
        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                Column(
                  children: [const Text("New"), Text(newWords)],
                ),
                Column(
                  children: [const Text("Reviewed"), Text(reviewWords)],
                ),
                Column(
